...
class Tb(nn.Module):#新四
    ...
    def forward(self, x):
        ...
        return self.出(torch.cat([x1,x2,x3,x4],1))#,x*self.辅(png1)
class Seg(nn.Module):#分割块
    def __init__(self, c=16):
        ...
        self.出3=nn.Sequential(Conv(2*c,2,3,1))
        self.出4=nn.Sequential(Conv(2*c,2,3,1))
